...
construction. Replay chain verified green across ALL FOUR projects (suite/heavy/arrival + `enrich` — the P2 ladder end-to-end replays in 25 s; recording it needed the fork-archive path: a tiny session gives /compact nothing to archive). 216 unit/integration.
